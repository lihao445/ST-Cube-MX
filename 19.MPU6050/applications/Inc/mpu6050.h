...
#define I2C_Write_SCL(x) HAL_GPIO_WritePin(I2C2_SCL_GPIO_Port, I2C2_SCL_Pin, x)
#define I2C_Write_SDA(x) HAL_GPIO_WritePin(I2C2_SDA_GPIO_Port, I2C2_SDA_Pin, x)

#define I2C_Read_SCL() HAL_GPIO_ReadPin(I2C2_SCL_GPIO_Port, I2C2_SCL_Pin)
#define I2C_Read_SDA() HAL_GPIO_ReadPin(I2C2_SDA_GPIO_Port, I2C2_SDA_Pin)
#endif
