...
void Remote_Control_Chassis_Mode(Chassis_Speed_t *chassis_speed)
{
    ...
    default:
		...
		yaw_delta = absolute_chassis_measure.Speed.vw / 660.0f * 0.01f;
...
{
    M3508_Target[0] = PID_velocity_realize_1(Speed_Motor_Target[0], 1) + PID_Yaw_realize(0);
    M3508_Target[1] = PID_velocity_realize_1(Speed_Motor_Target[1], 2) + PID_Yaw_realize(0);
    M3508_Target[2] = PID_velocity_realize_1(Speed_Motor_Target[2], 3) + PID_Yaw_realize(0);
