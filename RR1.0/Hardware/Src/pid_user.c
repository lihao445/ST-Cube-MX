...
{
	PID_init(&pid_v[5], PID_POSITION, motor_speed_3508_pid, 10000, 6000);
	PID_init(&pid_v[6], PID_POSITION, motor_speed_3508_pid, 10000, 6000);
	PID_init(&pid_v[7], PID_POSITION, motor_speed_3508_pid, 10000, 6000);
	PID_init(&pid_pos_2[1], PID_POSITION, motor_position_3508_pid, 400, 300);
}
