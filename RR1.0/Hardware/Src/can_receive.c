...
void CAN1_cmd_chassis_1(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4)    //can1_motor1-4为Chassis_motor
{
...
void CAN1_cmd_chassis_2(int16_t motor5, int16_t motor6, int16_t motor7, int16_t motor8) //can1_motor5为collect_motor    can1_motor6为shoot_motor1,  can1_motor7为shoot_motor2
{
 uint32_t send_mail_box;
...
void CAN2_cmd_chassis_1(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4)       //can2_motor1为cam_motor
{
 uint32_t send_mail_box;
