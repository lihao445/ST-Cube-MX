...
void CAN1_cmd_chassis_1(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4);
void CAN1_cmd_chassis_2(int16_t motor5, int16_t motor6, int16_t motor7, int16_t motor8);


void CAN2_Filter_Init(void);
void CAN2_cmd_chassis_1(int16_t motor1, int16_t motor2, int16_t motor3, int16_t motor4);
